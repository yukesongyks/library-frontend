...
declare const __VLS_export: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
  ...
  states: {
    inputValue: string;
    options: Map<EpPropMergeType<(StringConstructor | NumberConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>, OptionPublicInstance> & Omit<Map<EpPropMergeType<(StringConstructor | NumberConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>, OptionPublicInstance>, keyof Map<any, any>>;
    cachedOptions: Map<EpPropMergeType<(StringConstructor | NumberConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>, OptionPublicInstance> & Omit<Map<EpPropMergeType<(StringConstructor | NumberConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>, OptionPublicInstance>, keyof Map<any, any>>;
  ...
  getOption: (value: OptionValue) => {
    index: number;
    value: EpPropMergeType<(StringConstructor | NumberConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>;
    currentLabel: any;
  } | {
    index: number;
    value: EpPropMergeType<(StringConstructor | NumberConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>;
  ...
  ElOption: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
    value: {
      readonly type: _$vue.PropType<EpPropMergeType<(StringConstructor | NumberConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>>;
