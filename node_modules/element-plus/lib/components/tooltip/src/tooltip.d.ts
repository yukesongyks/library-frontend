...
declare const useTooltipProps: {
  ...
  trigger: EpPropFinalized<(new (...args: any[]) => "hover" | "click" | "contextmenu" | "focus" | TooltipTriggerType[]) | (() => Arrayable<TooltipTriggerType>) | (((new (...args: any[]) => "hover" | "click" | "contextmenu" | "focus" | TooltipTriggerType[]) | (() => Arrayable<TooltipTriggerType>)) | null)[], unknown, unknown, "hover", boolean>;
  ...
  role: EpPropFinalized<StringConstructor, "dialog" | "menu" | "tooltip" | "grid" | "group" | "listbox" | "navigation" | "tree", unknown, "tooltip", boolean>;
};
