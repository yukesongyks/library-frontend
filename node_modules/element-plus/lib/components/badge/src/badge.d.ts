...
declare const badgeProps: {
  ...
  readonly badgeClass: EpPropFinalized<(new (...args: any[]) => string | false | Record<string, any> | ClassValue[]) | (() => ClassValue) | (((new (...args: any[]) => string | false | Record<string, any> | ClassValue[]) | (() => ClassValue)) | null)[], unknown, unknown, undefined, boolean>;
};
/**
 * @deprecated Removed after 3.0.0, Use `BadgeProps` instead.
 */
