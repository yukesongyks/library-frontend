...
declare const progressProps: {
  ...
  readonly strokeLinecap: EpPropFinalized<(new (...args: any[]) => "round" | "inherit" | "butt" | "square") | (() => NonNullable<"round" | "inherit" | "butt" | "square" | undefined>) | (((new (...args: any[]) => "round" | "inherit" | "butt" | "square") | (() => NonNullable<"round" | "inherit" | "butt" | "square" | undefined>)) | null)[], unknown, unknown, "round", boolean>;
